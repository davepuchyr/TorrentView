...
export const torrents: Torrent[] = [
   {
      ...
      size: 5046586572,
      progress: 1,
      status: "seeding" as TorrentStatus,
      dlspeed: 0,
      upspeed: 1258291,
      eta: 0,
      ratio: 2.15,
   ...
   },
   {
      ...
      size: 75161927680,
      progress: 1,
      status: "completed" as TorrentStatus,
      dlspeed: 0,
      upspeed: 0,
      eta: 0,
      ratio: 1.01,
   ...
   },
   {
      ...
      size: 359661568,
      progress: 0.25,
      status: "paused" as TorrentStatus,
      dlspeed: 0,
      upspeed: 0,
      eta: Infinity,
      ratio: 0,
   ...
   },
   {
      ...
      name: "The.Matrix.1999.1080p.BluRay.x264-BestMovie",
      size: 8589934592,
      progress: 1,
      status: "seeding" as TorrentStatus,
      dlspeed: 0,
   ...
   {
      hash: "j0k1l2g7h8i9j0k1l2g7h8i9j0k1l2g7h8g7h8i9",
      name: "The.Matrix.1999.720p.WEB-DL.H264-Excellent",
      size: 3221225472,
      progress: 0.88,
      status: "downloading" as TorrentStatus,
      dlspeed: 4194304,
   ...
   {
      hash: "k1l2g7h8i9j0k1l2g7h8i9j0k1l2g7h8g7h8i9j0",
      name: "The.Matrix.1999.2160p.UHD.BluRay.x265-Ultimate",
      size: 26843545600,
      progress: 1,
      status: "completed" as TorrentStatus,
      dlspeed: 0,
